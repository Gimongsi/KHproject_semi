...
.smTitle_promo .title-part.line-4 {
	text-shadow: #035bb2 1px 1px, #055db2 2px 2px, #085eb1 3px 3px, #0a60b1
		...
		81px, #d1d089 82px 82px, #d4d289 83px 83px, #d6d388 84px 84px, #d9d488
		85px 85px, #dbd687 86px 86px, #ded787 87px 87px, #e0d986 88px 88px,
		#e3da86 89px 89px, #e6dc85 90px 90px;
}
...
>>>>>>> 0b6af0306be05b1152e3591d066c77cf2e3714a2
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<a href="#"><img id="calumn_src" name="calumn_src"
								src="/imgs/man-g2cdda0662_1920.jpg" class="d-block w-100"></a>
						...
						<div class="carousel-item">
							<a href="#"><img id="calumn_src" name="calumn_src"
								src="/imgs/crossfit-gee1621d57_1920.jpg" class="d-block w-100"></a>
							<div class="carousel-caption d-none d-md-block">
						...
						<div class="carousel-item">
							<a href="#"><img id="calumn_src" name="calumn_src"
								src="/imgs/sports-g92109f57b_1920.jpg" class="d-block w-100"></a>
							<div class="carousel-caption d-none d-md-block">
		...
		<div class="smTitle d-sm-none">
			<div class="waviy">
				<span style="-i: 1">오늘</span> <span style="-i: 2">할</span> <span
					style="-i: 3">운동은&nbsp;</span> <span style="-i: 5">?</span>
			</div>
		</div>
		...
		<div class="smTitle_promo_gym d-sm-none">여름대비 할인 진행 중!</div>
		<div class="title_promo d-none d-sm-block">
			<div class="content">
				<span class="title-part line-4">6월 프로모션</span>
			</div>
		</div>
		<div class="title_promo_gym d-none d-sm-block">여름대비 할인 진행 중!</div>
		<!-- 헬스장 -->
					...
					<c:forEach items="${gymList}" var="dtoGymPromo">
						<div class="col-6 col-sm-3 d-flex justify-content-center">
							<div class="card card_gym" style="width: 18rem;">
								<a href="/detail.gym?gym_seq=${dtoGymPromo.gym_seq}"
									style="text-decoration: none; color: black;"> <img
									id="gym_src" src="/files/${dtoGymPromo.gym_src_main}"
									class="card-img-top">
									<div class="card-body">
								...
								<ul class="list-group list-group-flush">
									<li class="list-group-item d-flex justify-content-end"
										id="gym_month">${dtoGymPromo.gym_month}개월</li>
									<li class="list-group-item d-flex justify-content-end"
										id="gym_price">${dtoGymPromo.gym_price}원</li>
									<li class="list-group-item d-flex justify-content-end">O.T
										1회 무료</li>
								</ul>
							</div>
						</div>
			...
			<c:choose>
				...
				<c:otherwise>
					<c:forEach items="${foodList}" var="dtoFoodPromo">
						<div class="col-6 col-sm-3 d-flex justify-content-center">
							<div class="card">
								<a href="${dtoFoodPromo.food_com}"
									style="text-decoration: none; color: black;"> <img
									src="/files/${dtoFoodPromo.food_src}" id="food_src"
									class="card-img-top"></a>
								<div class="card-body">
									<h5 class="card-title card_text" id="food_title"
										style="height: 40%;">${dtoFoodPromo.food_title}</h5>
									<p class="card-text card_text" id="food_name"
										style="height: 35%;">${dtoFoodPromo.food_name}</p>
									<p class="card-text d-flex justify-content-end">
										<small class="text-muted" id="food_price">${dtoFoodPromo.food_price}&nbsp;원</small>
									</p>
									<input type="text" class="d-none"
										value="${dtoFoodPromo.food_seq}">
								</div>
							</div>
						</div>
					</c:forEach>
