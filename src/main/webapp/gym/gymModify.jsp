...
<style>
    ...
    * {
    ...
    .btnAdd:hover, .btnMainPic:hover, .btnPics:hover,
    .btnBuy:hover {
        ...
        <div class="list-item-wrap">
            ...
            <div class="row detailBody">
                ...
                <div class="notice">
                    ...
                    <div class="row">
                        <div class="col content">
                            <textarea id="gym_comment" name="gym_comment" placeholder="공백 포함 500글자 이내로 입력하세요.">
                            </textarea>
                        </div>
                    </div>
                    <div class="empty"></div>
                ...
                <div class="noticeTime">
                    ...
                    <div class="row">
                        <div class="col content">
                            <textarea id="gym_time" name="gym_time" placeholder="예)AM 08:00 ~ PM 22:00
                            연중무휴"></textarea>
                        </div>
                    </div>
                    <div class="empty"></div>
                ...
                <div class="noticePic">
                    <div class="row">
                        ...
                        <div class="col d-flex justify-content-center">
                            <button class="btn btnPics" type="button" style="margin-bottom: 50px;">사진 등록</button>
                        </div>
                    </div>
