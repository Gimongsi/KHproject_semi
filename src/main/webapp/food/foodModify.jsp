    ...
    <div class="container">
            ...
            <table class="table d-none d-sm-block">
                <thead>
                    <tr class="tableTitle">
                        ...
                        <th scope="col">프로모션 내용(20자 이내)</th>
                        <th scope="col">프로모션 링크</th>
                        <th scope="col">사진 등록</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <th scope="row" style="text-align: center;">1</th>
                        <td id="food_name" name="food_name">[맛있닭] 통밀 또띠아</td>
                        <td id="food_title" name="food_title">가나다라마바사아자차카타파하일이삼사오육</td>
                        <td id="food_com" name="food_com">http://127.0.0.1:5500/My/int.html</td>
                        <td>
                            <button class="btn btnAdd" type="button">등록</button>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" style="text-align: center;">1</th>
                        <td id="food_name" name="food_name">[맛있닭] 통밀 또띠아</td>
                        <td id="food_title" name="food_title">가나다라마바사아자차카타파하일이삼사오육</td>
                        <td id="food_com" name="food_com">http://1y_headerMint.html</td>
                        <td>
                            <button class="btn btnAdd" type="button">등록</button>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td id="food_name" name="food_name">[맛있닭] 통밀 또띠아</td>
                        <td id="food_title" name="food_title">가나다라마바사아자차카타파하일이삼사오육</td>
                        <td id="food_com" name="food_com">http://127.0.headerMint.html</td>
                        <td>
                            <button class="btn btnAdd" type="button">등록</button>
                        </td>
                    </tr>
        ...
        <div class="row">
            <div class="col btnSpace d-flex justify-content-end">
                <button class="btn btnAdd" type="button">수정</button>
                <button class="btn btnAdd" type="button">저장</button>
            </div>
        </div>
        <div class="row">
            <div class="col d-flex justify-content-center">
