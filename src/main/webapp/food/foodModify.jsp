...
<body>
	<div class="container">
		...
		<div class="foodPromo">
			<form id="modifyForm" action="/modifyProc.food" method="post"
					...
					<div class="col d-flex justify-content-center">
						<div class="card">
							<c:if test="${empty dtoPic}">
								...
								<label class="btn btnPics" for="food_src" style="width: 100%;">사진
									등록</label>
								<input type="file" class="form-control inputCls" id="food_src"
