...
<script>
	Kakao.init('bae4e095dca79a945f06762d46be8b15');
</script>
</head>
					...
					<div class="LoginBox">
						...
						<div class="row m-2">
							<div class="col-11 d-flex justify-content-end">
								<button type="button" class="btn btn-light" id="searchIdBtn">로그인
									이메일 찾기</button>
								<button type="button" class="btn btn-light" id="searchPwBtn">비밀번호
									찾기</button>
							</div>
						</div>
						<div class="empty"></div>
